...
class ListProductionChannelRunsAction extends ProductionChannelAction
{
    protected function action(): Response
    {
        ...
        $validator->validate('channel_id', $formData['channel_id'] ?? null, 'integer|min:1');
        ...
        $params = [
            ...
            'channel_id' => $cleanData['channel_id'] ?? 0,
            'status' => $cleanData['status'] ?? 'all',
        ];

        $channelRuns = $this->productionChannelRepository->findAllChannelRuns(
            $params,
