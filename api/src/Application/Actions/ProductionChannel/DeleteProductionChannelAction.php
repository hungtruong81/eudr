...
class DeleteProductionChannelAction extends ProductionChannelAction
{
    protected function action(): Response
    {
        ...
        $deleteScope = Utils::resolveScope($permissions, 'production_channel', 'delete');
        ...
        $this->productionChannelRepository->deleteProductionChannelWithPermission(
