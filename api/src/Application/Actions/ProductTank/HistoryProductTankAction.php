...
class HistoryProductTankAction extends ProductTankAction
{
    /**
     * {@inheritdoc}
     */
    protected function action(): Response
    {
        ...
        // Check permission to view product tank history
        //$scope = Utils::resolveScope($permissions, 'product_tank.history', 'view');
        ...
        $data_history = $this->productTankRepository->getHistoryOfProductTank(
            $product_tank->getId(),
            $params,
            (int)$this->auth_data['user_id'],
            (string)$scope,
