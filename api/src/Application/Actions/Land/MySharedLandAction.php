...
class MySharedLandAction extends LandAction
{
    /**
     * {@inheritdoc}
     */
    protected function action(): Response
    {
        ...
        $validator->validate('owner_id', $formData['owner_id'] ?? null, 'integer|min:1');
        ...
        $lands = $this->landRepository->getMySharedLands((int)$this->auth_data['user_id'], $params);
