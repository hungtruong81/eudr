...
class ListLandAction extends LandAction
{
    /**
     * {@inheritdoc}
     */
    protected function action(): Response
    {
        ...
        $validator->validate('not_shared_with_user_id', $formData['not_shared_with_user_id'] ?? null, 'integer|min:0');
        ...
        $sanitizeRules = [
            ...
            'not_shared_with_user_id' => 'integer',
            'search' => 'string',
        ];
        ...
        $not_shared_with_user_id = $cleanData['not_shared_with_user_id'] ?? 0;
        ...
        $params = [
            ...
            "not_shared_with_user_id" => $not_shared_with_user_id,
