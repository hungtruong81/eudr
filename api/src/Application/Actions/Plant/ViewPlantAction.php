...
class ViewPlantAction extends PlantAction
{
    /**
     * {@inheritdoc}
     */
    protected function action(): Response
    {
        ...
        // Check permission to view plant
        $scope = Utils::resolveScope($permissions, 'plant', 'view');
        if (empty($scope)) {
        ...
        $res_return['data'] = $plant->jsonSerialize();
