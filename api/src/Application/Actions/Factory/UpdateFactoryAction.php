...
class UpdateFactoryAction extends FactoryAction
{
    /**
     * {@inheritdoc}
     */
    protected function action(): Response
    {
        ...
        // Check permission to update factory
        $scope = Utils::resolveScope($permissions, 'factory', 'update');
        if (empty($scope)) {
        ...
        $factory = $this->factoryRepository->updateFactoryWithPermission(
            $factory->getId(),
            $data_update,
            (int)$this->auth_data['user_id'],
            (string)$scope,
