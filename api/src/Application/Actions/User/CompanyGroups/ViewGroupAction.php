...
class ViewGroupAction extends CompanyGroupAction
{
    /**
     * {@inheritdoc}
     */
    protected function action(): Response
    {
        ...
        $groupPermissions = $this->companyGroupRepository->getGroupPermissions((int)$group->getId());
        ...
        $res_return['data'] = $group->jsonSerialize();
        $res_return['data']['permissions'] = $groupPermissions;
