...
class ArriveTransportationRouteAction extends TransportationRouteAction
{
    /**
     * {@inheritdoc}
     */
    protected function action(): Response
    {
        ...
        $validator->validate('arrival_time', $formData['arrival_time'] ?? null, 'required|date');
        ...
        $arrival_time = $cleanData['arrival_time'];
