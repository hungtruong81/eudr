...
class ListRollingRunsAction extends ProductionRollerAction
{
    protected function action(): Response
    {
        ...
        $validator->validate('roller_id', $formData['roller_id'] ?? null, 'integer|min:1');
