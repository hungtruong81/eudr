...
class ShipPalletAction extends PalletAction
{
    protected function action(): Response
    {
        ...
        $scope = Utils::resolveScope($permissions, 'pallet', 'ship');
        if (empty($scope)) {
        ...
        if ((string)$pallet->getStatus() !== 'packed') {
            throw new HttpBadRequestException($this->request, 'Chỉ xuất pallet ở trạng thái packed');
        }
