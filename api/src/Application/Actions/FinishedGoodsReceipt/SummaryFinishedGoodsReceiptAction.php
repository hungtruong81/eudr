...
class SummaryFinishedGoodsReceiptAction extends FinishedGoodsReceiptAction
{
    /**
     * {@inheritdoc}
     */
    protected function action(): Response
    {
        ...
        // include scope/company to enforce permissions
        $params['scope'] = (string)$scope;
        $params['company_id'] = $this->auth_data['company_id'] ?? null;

        $finished_goods_summary = $this->finishedGoodsReceiptRepository->productionFinishedGoodsSummary(
            $params,
        ...
        $res_return['data'] = $finished_goods_summary;
