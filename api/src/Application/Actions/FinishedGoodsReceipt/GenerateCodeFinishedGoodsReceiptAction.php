...
class GenerateCodeFinishedGoodsReceiptAction extends FinishedGoodsReceiptAction
{
    /**
     * {@inheritdoc}
     */
    protected function action(): Response
    {
        ...
        $log = array(
            ...
            "extra_1" => (string)$finished_goods_receipt_code,
        );
        Utils::save_log($this->logger, $log);

        $res_return = ["result" => "success"];
        $res_return['trace_id'] = $trace_id;
        $res_return['data'] = ['finished_goods_receipt_code' => $finished_goods_receipt_code];
