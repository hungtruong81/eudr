...
class DeleteProductionOvenAction extends ProductionOvenAction
{
    protected function action(): Response
    {
        ...
        $deleteScope = Utils::resolveScope($permissions, 'production_oven', 'delete');
        ...
        $this->productionOvenRepository->deleteProductionOvenWithPermission(
