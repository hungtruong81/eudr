...
class ListDryingRunsAction extends ProductionOvenAction
{
    protected function action(): Response
    {
        ...
        $validator->validate('oven_id', $formData['oven_id'] ?? null, 'integer|min:1');
