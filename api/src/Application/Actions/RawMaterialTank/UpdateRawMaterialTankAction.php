...
class UpdateRawMaterialTankAction extends RawMaterialTankAction
{
    /**
     * {@inheritdoc}
     */
    protected function action(): Response
    {
        ...
        // Check permission to update raw material tanks
        $scope = Utils::resolveScope($permissions, 'raw_material_tank', 'update');
        if (empty($scope)) {
        ...
        $raw_material_tank = $this->rawMaterialTankRepository->updateRawMaterialTankWithPermission(
        ...
        $res_return['raw_material_tank'] = $raw_material_tank->jsonSerialize();
