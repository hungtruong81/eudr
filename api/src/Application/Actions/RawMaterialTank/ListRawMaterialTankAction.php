...
class ListRawMaterialTankAction extends RawMaterialTankAction
{
    /**
     * {@inheritdoc}
     */
    protected function action(): Response
    {
        ...
        $validator->validate('tank_type', $formData['tank_type'] ?? null, 'in:latex,scrap_rubber,mixed,all');
        ...
        $tank_type = $cleanData['tank_type'] ?? 'all';
        ...
        $raw_material_tanks = $this->rawMaterialTankRepository->findAll(
            $params,
        ...
        $res_return['data'] = $raw_material_tanks;
