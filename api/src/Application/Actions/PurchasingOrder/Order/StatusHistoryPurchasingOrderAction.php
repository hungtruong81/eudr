...
final class StatusHistoryPurchasingOrderAction extends PurchasingOrderAction
{
    protected function action(): Response
    {
        ...
        return $this->respondWithData([
            ...
            'status_history' => $this->purchasingOrderRepository->getStatusHistory($order->getId()),
        ]);
    }
}
