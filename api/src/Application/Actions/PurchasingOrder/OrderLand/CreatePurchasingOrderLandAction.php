...
class CreatePurchasingOrderLandAction extends PurchasingOrderAction
{
    protected function action(): Response
    {
        ...
        $record = $this->purchasingOrderRepository->createOrderLandByOrderId(
            $purchaseOrderId,
            [
        ...
        if ($record === null) {
            throw new HttpBadRequestException($this->request, 'Không thể thêm vườn nguồn vào phiếu');
        }
