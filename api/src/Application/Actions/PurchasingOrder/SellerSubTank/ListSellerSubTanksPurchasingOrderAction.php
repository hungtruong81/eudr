...
class ListSellerSubTanksPurchasingOrderAction extends PurchasingOrderAction
{
    protected function action(): Response
    {
        ...
        $validator->validate('status', $query['status'] ?? null, 'string|in:declared,seller_confirmed,loaded,received,cancelled,all');
        ...
        $data = $this->purchasingOrderRepository->listSellerSubTanksByOrderId(
            $purchaseOrderId,
            [
                'page' => (int)$clean['page'],
