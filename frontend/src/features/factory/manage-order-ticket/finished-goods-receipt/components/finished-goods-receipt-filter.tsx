...
import { IGetFinishedGoodsReceiptParams } from "../actions";
import { useTranslations } from "next-intl";

const { RangePicker } = DatePicker;

interface IFinishedGoodsReceiptFilterProps {
  onSearch: (params: Partial<IGetFinishedGoodsReceiptParams>) => void;
}

const FinishedGoodsReceiptFilter = ({
  onSearch,
}: IFinishedGoodsReceiptFilterProps) => {
...
export default FinishedGoodsReceiptFilter;
