                ...
                <Row gutter={24}>
                  <Col xs={24} lg={10}>
                    ...
                    <Row gutter={16}>
                      <Col span={12}>
                        <Form.Item
                          ...
                          rules={[
                            { required: true, message: tCommon("select_province_error") || "Vui lòng chọn tỉnh!" },
                          ]}>
                          <Select
                            showSearch={{
                            ...
                            placeholder={tCommon("select_province")}
                      ...
                      <Col span={12}>
                        <Form.Item
                          ...
                          label={t("area_ha")}
                          rules={[
                            { required: true, message: t("area_required") },
                          ]}>
                          <InputNumber
                            style={{ width: "100%" }}
                            min={0}
                            placeholder={t("area_example")}
                          />
                        </Form.Item>
                      </Col>
                    </Row>
                    ...
                    <Form.Item
                      ...
                      label={t("harvest_weight")}
                      rules={[{ required: true, message: t("harvest_weight_required") }]}>
                      <InputNumber
                        style={{ width: "100%" }}
                        min={0}
                        placeholder={t("harvest_weight_example")}
                        formatter={(value) =>
                    ...
                    <Form.Item
                      ...
                      label={tCommon("address_detail")}
                      rules={[
                        { required: true, message: tCommon("address_required") || "Vui lòng nhập địa chỉ!" },
                      ]}>
                      <Input.TextArea
                        rows={2}
                        placeholder={tCommon("address_detail_placeholder")}
                      />
                    </Form.Item>
                    ...
                    <Form.Item
                      ...
                      <Input.TextArea
                        rows={2}
                        placeholder={t("plot_notes_placeholder")}
                      />
                    </Form.Item>
                  </Col>
                  ...
                  <Col xs={24} lg={14}>
                    <Form.Item
                      noStyle
                      dependencies={[["lands", field.name, "coordinates"]]}>
                      {({ getFieldValue }) => {
                            ...
                            {coordFields.map((coordField, cIndex) => (
                              <Space
                                ...
                                <Form.Item
                                  ...
                                  rules={[
                                    { required: true, message: t("lat_required") },
                                  ]}>
                                  <InputNumber
                                    placeholder="Lat"
                                    style={{ width: "140px" }}
                                ...
                                <Form.Item
                                  ...
                                  rules={[
                                    { required: true, message: t("lng_required") },
                                  ]}>
                                  <InputNumber
                                    placeholder="Lng"
                                    style={{ width: "140px" }}
